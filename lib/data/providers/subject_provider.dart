...
class SubjectProvider with ChangeNotifier {
  ...
  // void printValueOfControllers(
  //     List<TextEditingController> controllers, List<Color> subjectColors) {
  //   int countC = 1;
  //   int countCo = 1;
  //   print("--- Controller ---");
  //   for (var controller in controllers) {
  //     print("${countC.toString()}. ${controller.text}");
  //     countC += 1;
  //   }
  //   print("--- Color ---");
  //   for (var subjectColor in subjectColors) {
  //     print(
  //         "${countC.toString()}. 0x${subjectColor.value.toRadixString(16).toUpperCase()}");
  //     countC += 1;
  //   }
  // }
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> getSubjectsStream(User user) {
  ...
  Future<int> totalNoOfTopicsInSubject(User user, String subjectDoc) async {
