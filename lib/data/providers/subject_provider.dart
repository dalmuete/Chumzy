...
class SubjectProvider with ChangeNotifier {
  ...
  List<Subject> _subjects = [ Subject(
    ...
    Topic(
      title: "Chapter 3: Building Your First Mobile App with Flutter and Dart",
      totalNoItems: 12,
      lastUpdated: DateTime(2024, 11, 8, 8, 30),
    ),
    Topic(
      title: "Chapter 4: Understanding Widgets and the Widget Tree in Flutter",
      totalNoItems: 30,
    ...
    Topic(
      title: "Chapter 9: Working with External Packages and APIs in Flutter",
      totalNoItems: 25,
  ...
  topics: [
    ...
    Topic(
      title: "Chapter 5: Debugging and Performance Optimization for Systems",
      totalNoItems: 9,
      lastUpdated: DateTime(2024, 6, 22, 9, 10),
    ),
  ],
